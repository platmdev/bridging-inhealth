    ...
    function layoutSetting(id) {
        ...
        function applyTheme(theme) {
            if (theme === 'dark') {
                ...
                (body.hasAttribute("data-layout") && body.getAttribute("data-layout") == "horizontal") ? '' : document.body.setAttribute('data-sidebar', theme);
                $('#icon-mode').removeClass('uil-moon');
                $('#icon-mode').addClass('uil-sun');
                ...
                document.body.setAttribute('data-sidebar', theme);
                (body.hasAttribute("data-layout") && body.getAttribute("data-layout") == "horizontal") ? '' : document.body.setAttribute('data-sidebar', theme);
                $('#icon-mode').removeClass('uil-sun');
                $('#icon-mode').addClass('uil-moon');
